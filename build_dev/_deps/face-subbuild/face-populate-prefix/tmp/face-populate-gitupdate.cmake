...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.1.3"
  WORKING_DIRECTORY "/Users/rdchlmyl/repos/mayhlFUNWAVE/build_dev/_deps/face-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v1.1.3")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v1.1.3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/rdchlmyl/repos/mayhlFUNWAVE/build_dev/_deps/face-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/rdchlmyl/repos/mayhlFUNWAVE/build_dev/_deps/face-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
