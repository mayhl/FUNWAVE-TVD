...
module model_config_defaults_mod
   ...
   character(*), parameter :: DEF_BOUNDARIES_EAST_SPONGE_PML_CD = "10.0"
   character(*), parameter :: DEF_BOUNDARIES_EAST_SPONGE_PML_H_GATE = "2.0"
   character(*), parameter :: DEF_BOUNDARIES_EAST_SPONGE_PML_R_TARGET = "0.001"
   character(*), parameter :: DEF_BOUNDARIES_EAST_SPONGE_PML_WIDTH = "0.0"
   ...
   character(*), parameter :: DEF_BOUNDARIES_NORTH_SPONGE_PML_CD = "10.0"
   character(*), parameter :: DEF_BOUNDARIES_NORTH_SPONGE_PML_H_GATE = "2.0"
   character(*), parameter :: DEF_BOUNDARIES_NORTH_SPONGE_PML_R_TARGET = "0.001"
   character(*), parameter :: DEF_BOUNDARIES_NORTH_SPONGE_PML_WIDTH = "0.0"
   ...
   character(*), parameter :: DEF_BOUNDARIES_SOUTH_SPONGE_PML_CD = "10.0"
   character(*), parameter :: DEF_BOUNDARIES_SOUTH_SPONGE_PML_H_GATE = "2.0"
   character(*), parameter :: DEF_BOUNDARIES_SOUTH_SPONGE_PML_R_TARGET = "0.001"
   character(*), parameter :: DEF_BOUNDARIES_SOUTH_SPONGE_PML_WIDTH = "0.0"
   ...
   character(*), parameter :: DEF_BOUNDARIES_WEST_SPONGE_PML_CD = "10.0"
   character(*), parameter :: DEF_BOUNDARIES_WEST_SPONGE_PML_H_GATE = "2.0"
   character(*), parameter :: DEF_BOUNDARIES_WEST_SPONGE_PML_R_TARGET = "0.001"
   ...
   character(*), parameter :: DEF_BREAKING_CBRK1 = "0.55"
   ...
   character(*), parameter :: DEF_BREAKING_SOLVER = "split_implicit"
   ...
   character(*), parameter :: DEF_BREAKING_WETDRY_DISP_RAMP = "3.0"
   ! ── dispersion ──
